...
from src.plotresults import plot_results
...
class Models:
    ...
    def get_lr(self):
        ...
        test_score, test_confusion_matrix, _ = score_submission(actual_test_labels, predicted_test_labels)
        print_confusion_matrix(test_confusion_matrix)
        null_score, max_score = score_defaults(actual_test_labels)

        plot_results(predicted_test_labels, actual_test_labels)
